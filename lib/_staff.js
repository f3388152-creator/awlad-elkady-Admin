const { SUPABASE_URL, SERVICE_ROLE_KEY, supabase } = require('./_server');
...
module.exports = { normalizePhone, validPhone, loginEmail, cleanStaff, findByPhone, findById, listStaff, createStaff, updateStaff };
